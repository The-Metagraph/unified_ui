defmodule LiveUi.Demo.Server.Layouts do
  ...
  defp css do
    ...
    .live-ui-demo-example-breadcrumbs {
      display: flex;
      align-items: center;
      flex-wrap: wrap;
      gap: 0.5rem;
    ...
    .live-ui-demo-breadcrumb-link:hover {
      color: hsl(192 100% 62%);
    }

    .live-ui-demo-breadcrumb-separator {
      color: hsl(0 0% 100% / 0.42);
      font-size: 0.76rem;
    }

    .live-ui-demo-breadcrumb-current {
      color: var(--example-foreground);
      font-size: 0.82rem;
      letter-spacing: 0.04em;
      text-transform: uppercase;
