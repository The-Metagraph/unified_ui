defmodule LiveUi.DemoTest do
  ...
  test "native example workbench renders a preview through the shared runtime" do
    ...
    assert demo.html =~ "live-ui-demo-example-breadcrumbs"
    assert demo.html =~ ~s(href="/?category=native")
    assert demo.html =~ "Back To Overview"
