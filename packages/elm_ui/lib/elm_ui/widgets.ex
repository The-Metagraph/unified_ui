defmodule ElmUi.Widgets do
  ...
  alias ElmUi.Widget
  alias ElmUi.Widgets.{Collection, Data, Feedback, Forms, Foundational, Input, Layered, Layout}
  alias ElmUi.Widgets.{Navigation, Operational, Portable, Visualization}
  ...
  @spec host_form_shell(String.t() | atom(), [Widget.t() | map() | keyword()], keyword()) ::
          Widget.t()
  def host_form_shell(id, children, opts \\ []) do
    Forms.host_form_shell(id, children, opts)
  end
  ...
  @spec repeated_collection(String.t() | atom(), [Widget.t() | map() | keyword()], keyword()) ::
          Widget.t()
  def repeated_collection(id, rows, opts \\ []) do
    Collection.repeated_collection(id, rows, opts)
  end
