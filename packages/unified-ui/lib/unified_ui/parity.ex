defmodule UnifiedUi.Parity do
  ...
  @type parity_catalog :: %{
          ...
          semantic_widgets: [atom()],
          workflow_widgets: [atom()],
          advanced_widgets: [atom()],
          form_constructs: [atom()],
          collection_constructs: [atom()],
  ...
  def catalog do
    ...
    %{
      ...
      semantic_widgets: widgets.semantic,
      workflow_widgets: widgets.workflow,
      advanced_widgets: widgets.advanced,
      form_constructs: widgets.forms,
      collection_constructs: display.collection,
