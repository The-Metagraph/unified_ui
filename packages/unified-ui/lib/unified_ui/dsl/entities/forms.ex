defmodule UnifiedUi.Dsl.Entities.Forms do
  ...
  def top_level_entities do
    ...
    [field, field_group] = nested_entities()
    form_builder = form_builder_entity([field, field_group] ++ foundational ++ navigation)
  ...
  def nested_entities do
    ...
    field = field_entity(inputs)
    field_group = field_group_entity([field])
  ...
  defp field_entity(children) do
    %Spark.Dsl.Entity{
      ...
      identifier: :id,
      recursive_as: :children,
      auto_set_fields: [family: :forms, kind: :field],
      entities: [children: children],
      schema:
        EntitySchema.widget(
