defmodule UnifiedUi.Dsl.Node do
  ...
  @type t :: %__MODULE__{
          ...
          open?: boolean() | nil,
          content_label: String.t() | nil,
          icon: atom() | nil,
          initials: String.t() | nil,
          avatar_source: String.t() | nil,
          pulse?: boolean() | nil,
          artifact: term(),
          ...
          segments: term(),
          stages: term(),
          before_text: String.t() | nil,
          after_text: String.t() | nil,
          code: String.t() | nil,
          language: atom() | nil,
          actions: keyword(),
  ...
  def summary(%__MODULE__{} = node) do
    %{
      ...
      avatar_source: node.avatar_source,
      pulse?: node.pulse?,
      ...
      stages: node.stages,
      before_text: node.before_text,
      after_text: node.after_text,
      code: node.code,
      ...
      action_placement: node.action_placement,
      items: node.items,
