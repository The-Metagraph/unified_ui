defmodule TerminalUi.Runtime.EventRouter do
  @moduledoc """
  Deterministic routing between local terminal handling and canonical
  boundary translation.
  """

  alias TerminalUi.Runtime.{Error, State}
  ...
  defp validate_translation(%{family: family, boundary: boundary, runtime_event: runtime_event}) do
    if family in TerminalUi.Transport.families() and boundary in [:local, :boundary] and
