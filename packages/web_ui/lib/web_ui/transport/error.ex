defmodule WebUi.Transport.Error do
  @moduledoc """
  ...
  def renderer_local_event_name(event_name, surface) do
    %__MODULE__{
      ...
      message: "renderer-local event names must not enter the web_ui transport contract",
  ...
  def renderer_local_payload(keys, surface) do
    %__MODULE__{
      ...
      message: "renderer-local payload keys must not cross the web_ui transport boundary",
  ...
  def invalid_boundary_signal(value) do
    %__MODULE__{
      ...
      message: "boundary signals must contain canonical web_ui extensions and event context",
  ...
  def invalid_boundary_envelope(value) do
    %__MODULE__{
      ...
      message: "boundary envelopes must wrap a canonical web_ui signal payload",
      details: %{value: inspect(value)}
    }
  end
