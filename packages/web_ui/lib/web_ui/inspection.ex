defmodule WebUi.Inspection do
  @moduledoc """
  Package and runtime inspection helpers for `web_ui`.
  """
  ...
  def package_overview do
    %{
      widgets: %{
        families: WebUi.Widgets.families(),
        kinds: WebUi.Widgets.kinds()
      },
      style: %{
        primitives: Map.keys(WebUi.Style.primitives()),
        hooks: WebUi.Style.widget_style_hooks(),
        responsibilities: WebUi.Style.responsibilities()
      },
      theme: %{
