defmodule WebUi.Widgets.Foundational do
  @moduledoc """
  Foundational content and action widgets for direct-use `web_ui` screens.
  """
  ...
  @spec text(String.t() | atom(), String.t(), keyword() | map()) :: WebUi.Widget.t()
  ...
  @spec label(String.t() | atom(), String.t(), keyword() | map()) :: WebUi.Widget.t()
  ...
  @spec icon(String.t() | atom(), atom() | String.t(), keyword() | map()) :: WebUi.Widget.t()
  ...
  @spec image(String.t() | atom(), String.t(), keyword() | map()) :: WebUi.Widget.t()
  ...
  @spec button(String.t() | atom(), String.t(), keyword() | map()) :: WebUi.Widget.t()
  ...
  @spec link(String.t() | atom(), String.t(), String.t(), keyword() | map()) :: WebUi.Widget.t()
  ...
  @spec separator(String.t() | atom(), keyword() | map()) :: WebUi.Widget.t()
  ...
  @spec spacer(String.t() | atom(), keyword() | map()) :: WebUi.Widget.t()
  ...
  @spec content(String.t() | atom(), [WebUi.Widget.t() | map() | keyword()], keyword() | map()) ::
          WebUi.Widget.t()
