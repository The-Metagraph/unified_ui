defmodule WebUi.Widgets.Input do
  ...
  @spec numeric_input(String.t() | atom(), keyword() | map()) :: WebUi.Widget.t()
  ...
  @spec date_input(String.t() | atom(), keyword() | map()) :: WebUi.Widget.t()
  ...
  @spec time_input(String.t() | atom(), keyword() | map()) :: WebUi.Widget.t()
  ...
  @spec file_input(String.t() | atom(), keyword() | map()) :: WebUi.Widget.t()
  ...
  @spec slider(String.t() | atom(), keyword() | map()) :: WebUi.Widget.t()
  ...
  @spec toggle(String.t() | atom(), keyword() | map()) :: WebUi.Widget.t()
  ...
  @spec pick_list(String.t() | atom(), [keyword() | map()], keyword() | map()) :: WebUi.Widget.t()
