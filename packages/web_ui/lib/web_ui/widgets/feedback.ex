defmodule WebUi.Widgets.Feedback do
  ...
  @spec status(String.t() | atom(), String.t(), keyword() | map()) :: WebUi.Widget.t()
  ...
  @spec progress(String.t() | atom(), keyword() | map()) :: WebUi.Widget.t()
  ...
  @spec inline_feedback(String.t() | atom(), String.t(), keyword() | map()) :: WebUi.Widget.t()
