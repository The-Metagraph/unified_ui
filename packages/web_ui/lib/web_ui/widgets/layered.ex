defmodule WebUi.Widgets.Layered do
  ...
  @spec dialog(String.t() | atom(), WebUi.Widget.t() | map() | keyword(), keyword() | map()) ::
          WebUi.Widget.t()
  ...
  @spec toast(String.t() | atom(), WebUi.Widget.t() | map() | keyword(), keyword() | map()) ::
          WebUi.Widget.t()
  ...
  defp validate_layers!([]) do
    raise ArgumentError, "web_ui overlay widgets require at least one layer widget"
  end

  defp validate_layers!(layers) do
    if Enum.any?(layers, &(&1.family != :layer)) do
      raise ArgumentError,
            "web_ui overlay widgets require every overlay layer to use the :layer family"
    end
  end
