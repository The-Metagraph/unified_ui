defmodule WebUi.Widgets.Visualization do
  ...
  @spec gauge(String.t() | atom(), keyword() | map()) :: WebUi.Widget.t()
  ...
  @spec sparkline(String.t() | atom(), [number()], keyword() | map()) :: WebUi.Widget.t()
  ...
  @spec canvas(String.t() | atom(), [keyword() | map()], keyword() | map()) :: WebUi.Widget.t()
