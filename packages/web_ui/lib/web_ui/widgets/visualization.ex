defmodule WebUi.Widgets.Visualization do
  @moduledoc """
  Advanced charting and canvas widgets for direct-use `web_ui` dashboards.
  """
  ...
  @spec gauge(keyword() | map()) :: WebUi.Widget.t()
  def gauge(opts \\ []) do
    opts = Builder.options(opts)

    Builder.widget(:gauge,
      id: Builder.require_id!(opts, :gauge),
      props: %{
  ...
  @spec sparkline([number()], keyword() | map()) :: WebUi.Widget.t()
  def sparkline(series, opts \\ []) when is_list(series) do
    opts = Builder.options(opts)

    Builder.widget(:sparkline,
      id: Builder.require_id!(opts, :sparkline),
      props: %{
  ...
  @spec bar_chart([keyword() | map()], keyword() | map()) :: WebUi.Widget.t()
  def bar_chart(series, opts \\ []) when is_list(series) do
    chart(:bar_chart, series, opts)
  end

  @spec line_chart([keyword() | map()], keyword() | map()) :: WebUi.Widget.t()
  def line_chart(series, opts \\ []) when is_list(series) do
    chart(:line_chart, series, opts)
  end

  @spec canvas([keyword() | map()], keyword() | map()) :: WebUi.Widget.t()
  def canvas(operations, opts \\ []) when is_list(operations) do
    opts = Builder.options(opts)

    Builder.widget(:canvas,
      id: Builder.require_id!(opts, :canvas),
      props: %{
