# Unified Examples Alert dialog

This standalone Phoenix LiveView app demonstrates the `alert_dialog` widget through the shared example-suite DSL template, theme, and style profile.
...
If the example uses the shared trigger, click `Inspect the alert dialog layered story`.
