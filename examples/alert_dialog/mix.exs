defmodule UnifiedExamples.AlertDialog.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Standalone alert dialog example app for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
  ...
  defp docs do
    [
      main: "UnifiedExamples.AlertDialog",
      extras: ["README.md"],
      source_ref: "main",
