defmodule UnifiedExamples.SplitPane.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Standalone split-pane example app for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
  ...
  defp docs do
    [
      main: "UnifiedExamples.SplitPane",
      extras: ["README.md"],
      source_ref: "main",
