# Unified Examples Split pane

This standalone Phoenix LiveView app demonstrates the `split_pane` widget through the shared example-suite DSL template, theme, and style profile.
...
If the example uses the shared trigger, click `Inspect the split pane display story`.
