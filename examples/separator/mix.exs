defmodule UnifiedExamples.Separator.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Baseline standalone example-app skeleton for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
  ...
  defp docs do
    [
      main: "UnifiedExamples.Separator",
      extras: ["README.md"],
      source_ref: "main",
