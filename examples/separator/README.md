# Unified Examples Separator

This standalone Phoenix LiveView app demonstrates the `separator` widget through the shared example-suite DSL template, theme, and style profile.
...
If the example uses the shared trigger, click `Highlight the separator story`.
