defmodule UnifiedExamples.Toggle.Helpers do
  ...
  @interaction_demo %{
    ...
    trigger_label: nil,
    idle_prompt:
      "Interact with the toggle example to see how its authored change signal updates the shared review story.",
    outcome:
      "The review panel should explain how the toggle example turns live form input into a browser-visible change outcome.",
  ...
  @metadata %{
    ...
    notes:
      "Toggle examples keep the local form shell while foregrounding one boolean switch control.",
    widget: :toggle,
