# Unified Examples Toggle

This standalone Phoenix LiveView app demonstrates the `toggle` widget through the shared example-suite DSL template, theme, and style profile.
