defmodule UnifiedExamples.ScrollBar.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Standalone scroll-bar example app for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
  ...
  defp docs do
    [
      main: "UnifiedExamples.ScrollBar",
      extras: ["README.md"],
      source_ref: "main",
