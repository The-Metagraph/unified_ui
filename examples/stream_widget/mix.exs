defmodule UnifiedExamples.StreamWidget.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Standalone stream-widget example app for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
  ...
  defp docs do
    [
      main: "UnifiedExamples.StreamWidget",
      extras: ["README.md"],
      source_ref: "main",
