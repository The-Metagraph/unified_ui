defmodule UnifiedExamples.MarkdownViewer.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Standalone markdown viewer example app for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
  ...
  defp docs do
    [
      main: "UnifiedExamples.MarkdownViewer",
      extras: ["README.md"],
      source_ref: "main",
