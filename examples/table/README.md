# Unified Examples Table

This standalone Phoenix LiveView app demonstrates the `table` widget through the shared example-suite DSL template, theme, and style profile.
...
If the example uses the shared trigger, click `Inspect the table data story`.
