defmodule UnifiedExamples.Field.Helpers do
  ...
  @interaction_demo %{
    ...
    trigger_label: nil,
    idle_prompt:
      "Interact with the field example to see how its authored change signal updates the shared review story.",
    outcome:
      "The review panel should explain how the field example turns live form input into a browser-visible change outcome.",
  ...
  @metadata %{
    ...
    notes:
      "Field examples keep the local form shell while foregrounding one primary labeled field.",
    widget: :field,
