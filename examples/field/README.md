# Unified Examples Field

This standalone Phoenix LiveView app demonstrates the `field` widget through the shared example-suite DSL template, theme, and style profile.
