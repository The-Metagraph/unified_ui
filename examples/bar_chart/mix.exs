defmodule UnifiedExamples.BarChart.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Standalone bar chart example app for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
