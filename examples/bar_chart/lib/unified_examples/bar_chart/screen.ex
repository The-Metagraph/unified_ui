  ...
  composition do
    ...
    box :bar_chart_example_screen_shell do
      ...
      text :bar_chart_example_screen_notes_text do
        value("Bar chart examples foreground one canonical categorical chart inside the local shell.")
        theme_ref(Theme.default_theme_id())
...
defmodule UnifiedExamples.BarChart.Helpers do
  ...
  @metadata %{
    ...
    notes: "Bar chart examples foreground one canonical categorical chart inside the local shell.",
    widget: :bar_chart,
