# Unified Examples Bar chart

This standalone Phoenix LiveView app demonstrates the `bar_chart` widget through the shared example-suite DSL template, theme, and style profile.
...
If the example uses the shared trigger, click `Inspect the bar chart feedback story`.
