defmodule UnifiedExamples.FormBuilder.Helpers do
  ...
  @interaction_demo %{
    ...
    trigger_label: nil,
    idle_prompt:
      "Interact with the form builder example to see how its authored change signal updates the shared review story.",
    outcome:
      "The review panel should explain how the form builder example turns live form input into a browser-visible change outcome.",
  ...
  @metadata %{
    ...
    notes:
      "Form builder examples keep the local form shell while foregrounding one primary form workflow.",
    widget: :form_builder,
