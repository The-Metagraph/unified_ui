# Unified Examples Form builder

This standalone Phoenix LiveView app demonstrates the `form_builder` widget through the shared example-suite DSL template, theme, and style profile.
