defmodule UnifiedExamples.FormBuilder.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Standalone form_builder example app for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
  ...
  defp docs do
    [
      main: "UnifiedExamples.FormBuilder",
      extras: ["README.md"],
      source_ref: "main",
