defmodule UnifiedExamples.LogViewer.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Standalone log viewer example app for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
  ...
  defp docs do
    [
      main: "UnifiedExamples.LogViewer",
      extras: ["README.md"],
      source_ref: "main",
