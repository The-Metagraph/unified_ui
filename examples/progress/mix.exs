defmodule UnifiedExamples.Progress.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Standalone progress example app for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
