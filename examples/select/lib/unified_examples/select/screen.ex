defmodule UnifiedExamples.Select.Helpers do
  ...
  @interaction_demo %{
    ...
    trigger_label: nil,
    idle_prompt:
      "Interact with the select example to see how its authored selection signal updates the shared review story.",
    outcome:
      "The review panel should explain how the select example turns live form input into a browser-visible selection outcome.",
  ...
  @metadata %{
    ...
    notes:
      "Select examples keep the local form shell while foregrounding one menu-based choice control.",
    widget: :select,
