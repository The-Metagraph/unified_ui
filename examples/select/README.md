# Unified Examples Select

This standalone Phoenix LiveView app demonstrates the `select` widget through the shared example-suite DSL template, theme, and style profile.
