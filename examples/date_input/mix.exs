defmodule UnifiedExamples.DateInput.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Standalone date_input example app for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
  ...
  defp docs do
    [
      main: "UnifiedExamples.DateInput",
      extras: ["README.md"],
      source_ref: "main",
