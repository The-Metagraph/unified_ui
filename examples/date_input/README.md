# Unified Examples Date input

This standalone Phoenix LiveView app demonstrates the `date_input` widget through the shared example-suite DSL template, theme, and style profile.
