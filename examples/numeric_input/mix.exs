defmodule UnifiedExamples.NumericInput.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Standalone numeric_input example app for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
  ...
  defp docs do
    [
      main: "UnifiedExamples.NumericInput",
      extras: ["README.md"],
      source_ref: "main",
