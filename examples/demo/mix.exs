defmodule UnifiedExamples.Demo.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Aggregate demo app for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
  ...
  defp application_module do
    UnifiedExamples.Demo.Application
  end
