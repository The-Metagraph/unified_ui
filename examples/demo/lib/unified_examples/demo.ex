defmodule UnifiedExamples.Demo do
  ...
  alias UnifiedExamples.Shared.Runtime, as: SharedRuntime
  ...
  @spec extra_content(map()) :: Phoenix.HTML.Safe.t()
  ...
  defp category_component(fragment_module) do
    case SharedRuntime.component_assigns(fragment_module) do
      {:ok, assigns} ->
