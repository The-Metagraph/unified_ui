defmodule UnifiedExamples.LineChart.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Standalone line chart example app for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
  ...
  defp docs do
    [
      main: "UnifiedExamples.LineChart",
      extras: ["README.md"],
      source_ref: "main",
