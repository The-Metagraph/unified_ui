# Unified Examples Line chart

This standalone Phoenix LiveView app demonstrates the `line_chart` widget through the shared example-suite DSL template, theme, and style profile.
...
If the example uses the shared trigger, click `Inspect the line chart feedback story`.
