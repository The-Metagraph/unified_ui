defmodule UnifiedExamples.Checkbox.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Standalone checkbox example app for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
