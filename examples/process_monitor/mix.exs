defmodule UnifiedExamples.ProcessMonitor.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Standalone process-monitor example app for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
  ...
  defp docs do
    [
      main: "UnifiedExamples.ProcessMonitor",
      extras: ["README.md"],
      source_ref: "main",
