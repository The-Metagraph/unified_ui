defmodule UnifiedExamples.CommandPalette.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Standalone command palette example app for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
  ...
  defp docs do
    [
      main: "UnifiedExamples.CommandPalette",
      extras: ["README.md"],
      source_ref: "main",
