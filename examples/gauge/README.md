# Unified Examples Gauge

This standalone Phoenix LiveView app demonstrates the `gauge` widget through the shared example-suite DSL template, theme, and style profile.
...
If the example uses the shared trigger, click `Inspect the gauge feedback story`.
