defmodule UnifiedExamples.ClusterDashboard.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Standalone cluster-dashboard example app for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
  ...
  defp docs do
    [
      main: "UnifiedExamples.ClusterDashboard",
      extras: ["README.md"],
      source_ref: "main",
