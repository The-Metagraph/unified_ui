defmodule UnifiedExamples.SupervisionTreeViewer.Helpers do
  ...
  @interaction_demo %{
    ...
    outcome:
      "The review panel should explain how the supervision tree viewer example turns an authored canonical interaction into a browser-visible operational story.",
  ...
  @metadata %{
    ...
    notes:
      "Supervision-tree examples foreground one canonical supervision hierarchy inside the local shell.",
    widget: :supervision_tree_viewer,
