defmodule UnifiedExamples.RadioGroup.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Standalone radio_group example app for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
  ...
  defp docs do
    [
      main: "UnifiedExamples.RadioGroup",
      extras: ["README.md"],
      source_ref: "main",
