defmodule UnifiedExamples.ContextMenu.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Standalone context menu example app for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
  ...
  defp docs do
    [
      main: "UnifiedExamples.ContextMenu",
      extras: ["README.md"],
      source_ref: "main",
