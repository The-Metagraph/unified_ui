# Unified Examples Context menu

This standalone Phoenix LiveView app demonstrates the `context_menu` widget through the shared example-suite DSL template, theme, and style profile.
...
If the example uses the shared trigger, click `Inspect the context menu layered story`.
