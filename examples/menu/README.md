# Unified Examples Menu

This standalone Phoenix LiveView app demonstrates the `menu` widget through the shared example-suite DSL template, theme, and style profile.
...
If the example uses the shared trigger, click `Review the menu navigation story`.
