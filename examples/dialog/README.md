# Unified Examples Dialog

This standalone Phoenix LiveView app demonstrates the `dialog` widget through the shared example-suite DSL template, theme, and style profile.
...
If the example uses the shared trigger, click `Inspect the dialog layered story`.
