# Unified Examples Status

This standalone Phoenix LiveView app demonstrates the `status` widget through the shared example-suite DSL template, theme, and style profile.
...
If the example uses the shared trigger, click `Inspect the status feedback story`.
