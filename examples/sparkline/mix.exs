defmodule UnifiedExamples.Sparkline.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Standalone sparkline example app for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
  ...
  defp docs do
    [
      main: "UnifiedExamples.Sparkline",
      extras: ["README.md"],
      source_ref: "main",
