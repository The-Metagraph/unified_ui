defmodule UnifiedExamples.InlineFeedback.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Standalone inline feedback example app for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
  ...
  defp docs do
    [
      main: "UnifiedExamples.InlineFeedback",
      extras: ["README.md"],
      source_ref: "main",
