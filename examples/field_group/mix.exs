defmodule UnifiedExamples.FieldGroup.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Standalone field_group example app for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
  ...
  defp docs do
    [
      main: "UnifiedExamples.FieldGroup",
      extras: ["README.md"],
      source_ref: "main",
