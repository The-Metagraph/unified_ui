defmodule UnifiedExamples.FileInput.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Standalone file_input example app for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
  ...
  defp docs do
    [
      main: "UnifiedExamples.FileInput",
      extras: ["README.md"],
      source_ref: "main",
