# Unified Examples File input

This standalone Phoenix LiveView app demonstrates the `file_input` widget through the shared example-suite DSL template, theme, and style profile.
