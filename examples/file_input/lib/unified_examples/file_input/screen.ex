defmodule UnifiedExamples.FileInput.Helpers do
  ...
  @interaction_demo %{
    ...
    trigger_label: nil,
    idle_prompt:
      "Interact with the file input example to see how its authored change signal updates the shared review story.",
    outcome:
      "The review panel should explain how the file input example turns live form input into a browser-visible change outcome.",
  ...
  @metadata %{
    ...
    notes:
      "File input examples keep the local form shell while foregrounding one file picker control.",
    widget: :file_input,
