# Unified Examples Canvas

This standalone Phoenix LiveView app demonstrates the `canvas` widget through the shared example-suite DSL template, theme, and style profile.
...
If the example uses the shared trigger, click `Inspect the canvas display story`.
