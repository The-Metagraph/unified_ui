defmodule UnifiedExamples.TextInput.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Standalone text_input example app for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
  ...
  defp docs do
    [
      main: "UnifiedExamples.TextInput",
      extras: ["README.md"],
      source_ref: "main",
