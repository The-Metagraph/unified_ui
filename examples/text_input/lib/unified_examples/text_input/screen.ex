defmodule UnifiedExamples.TextInput.Screen do
  @moduledoc """
  Self-contained text_input proof for the standalone example-app suite.
  """

  use UnifiedUi.Dsl

  alias UnifiedExamples.TextInput.Helpers
  alias UnifiedExamples.TextInput.StyleProfile
  alias UnifiedExamples.TextInput.Theme
  ...
  identity do
    ...
    authored_ref([:examples, :text_input_example_screen])
    tags([:example, :text_input])
  end
  ...
  composition do
    root(:text_input_example_screen_root)
    mode(:screen)
    summary("Self-contained example-app shell")

    box :text_input_example_screen_shell do
      theme_ref(Theme.default_theme_id())
      style_refs([:example_shell])
      tone(:surface)
      variant(:panel)

      text :text_input_example_screen_title do
        value("Text Input Widget Example")
        theme_ref(Theme.default_theme_id())
      ...
      text :text_input_example_screen_summary do
      ...
      box :text_input_example_screen_panel do
        theme_ref(Theme.default_theme_id())
      ...
      text :text_input_example_screen_notes_text do
        value("Type in the field to inspect the canonical change signal compiled from the self-contained authored DSL.")
        theme_ref(Theme.default_theme_id())
...
defmodule UnifiedExamples.TextInput.Helpers do
  @moduledoc false
  ...
  @interaction_demo %{
    ...
    target_surface: "text input review panel",
    reviewer_hint:
...
defmodule UnifiedExamples.TextInput.Theme do
  @moduledoc false
...
defmodule UnifiedExamples.TextInput.StyleProfile do
  @moduledoc false
