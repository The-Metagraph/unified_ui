defmodule UnifiedExamples.TimeInput.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      description: "Standalone time_input example app for the unified example suite.",
      deps: deps(),
      docs: docs(),
      package: package()
    ]
  ...
  defp docs do
    [
      main: "UnifiedExamples.TimeInput",
      extras: ["README.md"],
      source_ref: "main",
