defmodule UnifiedExamples.TimeInput.Helpers do
  ...
  @interaction_demo %{
    ...
    trigger_label: nil,
    idle_prompt:
      "Interact with the time input example to see how its authored change signal updates the shared review story.",
    outcome:
      "The review panel should explain how the time input example turns live form input into a browser-visible change outcome.",
  ...
  composition do
    ...
    form_builder :time_input_example_screen_shell do
      ...
      text :time_input_example_screen_notes_text do
        value(
          "Time input examples keep the local form shell while foregrounding one time control."
        )
