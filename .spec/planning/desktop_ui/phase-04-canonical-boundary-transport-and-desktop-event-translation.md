...
[ ] 4 Phase 4 - Canonical Boundary Transport and Desktop Event Translation
  ...
  [ ] 4.1 Section - Canonical Event Translation Backbone
    ...
    [ ] 4.1.2 Task - Implement native desktop input normalization
      ...
      [ ] 4.1.2.1 Subtask - Define the shared native desktop event model for clicks, key input, focus changes, shortcuts, menus, and window-local events.
      [ ] 4.1.2.2 Subtask - Normalize SDL2 and platform-local input families into the shared native event model before any canonical translation occurs.
  ...
  [ ] 4.3 Section - Transport Diagnostics and Contract Hygiene
    ...
    [ ] 4.3.1 Task - Implement transport diagnostics and validation helpers
      ...
      [ ] 4.3.1.2 Subtask - Implement validation helpers that catch raw SDL2 or platform-local leakage at the package boundary.
  ...
  [ ] 4.4 Section - Transport Comparison Examples
    ...
    [ ] 4.4.1 Task - Implement transport-oriented native and canonical examples
      ...
      [ ] 4.4.1.1 Subtask - Add direct-native examples that exercise focus, shortcuts, menus, and window-management interactions.
    ...
    [ ] 4.4.2 Task - Implement normalized-input comparison helpers
      ...
      [ ] 4.4.2.1 Subtask - Add helper workflows that compare normalized input across Windows, macOS, and Linux adapters.
      ...
      [ ] 4.4.2.3 Subtask - Document where later release workflows will package and validate these interaction families.
