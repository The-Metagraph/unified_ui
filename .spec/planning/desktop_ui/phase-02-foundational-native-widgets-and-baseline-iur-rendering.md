...
- Foundational direct-native widgets should arrive before advanced desktop
  constructs such as overlays, multiwindow coordination, and canvas surfaces.
...
[ ] 2 Phase 2 - Foundational Native Widgets and Baseline IUR Rendering
  ...
  [ ] 2.1 Section - Foundational Native Widget Families
    ...
    [ ] 2.1.1 Task - Implement foundational content and action widgets
      Create the first direct-native `desktop_ui` widgets for text, icons,
      images, buttons, and content containers.

      [ ] 2.1.1.1 Subtask - Implement content widgets for text, labels, icons, images, spacers, and separators.
    ...
    [ ] 2.1.2 Task - Implement baseline forms and navigation widgets
      ...
      [ ] 2.1.2.2 Subtask - Implement tabs, menus, breadcrumbs, lists, and foundational navigation surfaces appropriate to desktop usage.
  ...
  [ ] 2.3 Section - Baseline Canonical IUR Rendering
    ...
    [ ] 2.3.1 Task - Implement foundational canonical mapper coverage
      ...
      interaction descriptors into the native `desktop_ui` surface.
      ...
      [ ] 2.3.1.3 Subtask - Accept canonical bindings and interaction descriptors without requiring authored DSL modules inside `desktop_ui`.
    ...
    [ ] 2.3.2 Task - Implement deterministic native-widget reuse for canonical rendering
      ...
      [ ] 2.3.2.2 Subtask - Define deterministic canonical-to-native mapping expectations for widget structure, focus behavior, and styling hooks.
