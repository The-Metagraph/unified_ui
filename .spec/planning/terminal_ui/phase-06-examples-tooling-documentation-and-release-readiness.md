...
[ ] 6 Phase 6 - Examples, Tooling, Documentation, and Release Readiness
  ...
  [ ] 6.1 Section - Maintained Reference Examples
    ...
    [ ] 6.1.1 Task - Implement maintained direct-native example coverage
      ...
      [ ] 6.1.1.1 Subtask - Add maintained direct-native examples for foundational, advanced, styled, and transport-heavy terminal flows.
      [ ] 6.1.1.2 Subtask - Keep example metadata aligned with widget-family, transport, styling, and capability coverage summaries.
    ...
    [ ] 6.1.2 Task - Implement maintained canonical example coverage
      ...
      [ ] 6.1.2.1 Subtask - Add maintained canonical examples for foundational, advanced, styled, and transport-heavy terminal flows.
