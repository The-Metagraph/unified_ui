...
- Maintained examples, tooling, and documentation are release surfaces rather than optional extras for `elm_ui`.
...
[x] 6 Phase 6 - Examples, Tooling, Documentation, and Release Readiness
  Implement maintained reference examples, preview and inspection tooling, documentation, release-readiness gates, and package evolution workflows for `elm_ui`.
  ...
  [x] 6.4 Section - Release Readiness and Evolution Workflow
    Implement the release gates and maintainer workflow rules that keep `elm_ui` aligned with ecosystem contracts over time.
